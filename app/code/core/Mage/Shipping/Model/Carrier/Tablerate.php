    ...
    public function getCode($type, $code = '')
    {
        $codes = array(
            ...
            'condition_name_short' => array(
                'package_weight' => Mage::helper('shipping')->__('Weight (para arriba)'),
                'package_value' => Mage::helper('shipping')->__('Order Subtotal (para arriba)'),
                'package_qty' => Mage::helper('shipping')->__('# of Items (para arriba)'),
            ),
